...
- **Environnements** (chaque espace a sa propre adresse, mise à jour automatiquement) :
  - Binôme 1 → https://interne.acobi.fr/workshop/groupe4/binome1/
  - Binôme 2 → https://interne.acobi.fr/workshop/groupe4/binome2/
  - Intégration du groupe → https://interne.acobi.fr/workshop/groupe4/dev/
  - **Portail (version finale, visible de toute l'entreprise)** → https://interne.acobi.fr/apps/groupe4/
